...
const Section = ({
  ...
  return (
    <div
      ...
      className={`relative ${
        customPaddings ||
        `py-10 lg:py-16 xl:py- ${crosses ? "lg:py-32 xl:py-40" : ""}`
      } 
        ${className || ""}`}
    >
      {children}
      ...
      {crosses && (
        <>
          <div
            className={`hidden absolute top-0 left-75 right-7.5 h-0.5 bg-stroke-1
                    ${crossesOffset && crosses} pointer-events-none
                    lg:block
                    xl:left-10 right-10`}
          />
